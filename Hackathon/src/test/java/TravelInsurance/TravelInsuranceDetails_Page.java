...
public class TravelInsuranceDetails_Page{
	...
	public void numberOfPeople() {
		WebDriverWait wait=new WebDriverWait(driver, Duration.ofSeconds(10));
        wait.until(ExpectedConditions.elementToBeClickable(nop));
		nop.click();
	}
	...
	public void nodisease() {
		WebDriverWait wait=new WebDriverWait(driver, Duration.ofSeconds(10));
        wait.until(ExpectedConditions.elementToBeClickable(nodisease));
		nodisease.click();
	}
	...
	public void mobileNumber(String validMob) {
		WebDriverWait wait=new WebDriverWait(driver, Duration.ofSeconds(10));
        wait.until(ExpectedConditions.elementToBeClickable(mobnum));
